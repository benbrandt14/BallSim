...
@testset "3D Shapes" begin
    @testset "Box3D" begin
        ...
        # Normals
        # Right face
        @test BallSim.Common.normal(b, SVector(1.1f0, 0.0f0, 0.0f0), 0.0f0) ≈
              SVector(1.0f0, 0.0f0, 0.0f0)
        # Top face
        @test BallSim.Common.normal(b, SVector(0.0f0, 1.1f0, 0.0f0), 0.0f0) ≈
              SVector(0.0f0, 1.0f0, 0.0f0)
        # Front face
        @test BallSim.Common.normal(b, SVector(0.0f0, 0.0f0, 1.1f0), 0.0f0) ≈
